...
$string['settings_tokenduration_desc'] = 'How long each generated transfer token remains valid. The default is 7 days.';
...
$string['backup_destination_missing'] = 'The MBZ backup file was not created.';
$string['backup_errors_found_desc'] = '{$a} backup job(s) failed. Review the error details and requeue them after correcting the problem.';
$string['backup_errors_found_title'] = 'Backup errors require attention';
$string['backup_errors_open_report'] = 'Open backup report';
$string['backup_ftp_upload_failed'] = 'Failed to send the backup to {$a->remote_file}. File size: {$a->size}. Error: {$a->error}';
$string['backup_no_destination'] = 'No backup destination is enabled. Enable FTP or local storage in the plugin settings.';
$string['backup_status_completed'] = 'Completed';
$string['backup_status_error'] = 'Error';
$string['backup_status_initiated'] = 'Running';
$string['backup_status_waiting'] = 'Waiting';
$string['backup_tempfile_unreadable'] = 'The temporary backup file cannot be read: {$a}';
$string['backup_unexpected_error'] = 'Unexpected error while creating the backup: {$a}';
$string['manual_cron_result_error'] = 'The task finished with errors';
$string['manual_cron_result_success'] = 'The task finished successfully';
