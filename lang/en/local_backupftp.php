...
$string['backup_restart'] = 'Redo this backup';
...
$string['cron'] = 'CRON';
$string['cron_task'] = 'Manual CRON execution';
...
$string['ftp_files'] = 'Files on FTP and Local';
...
$string['run_cron'] = 'Manual CRON execution';
$string['runtask_backup'] = 'Process backup queue';
$string['runtask_click_here'] = 'Click here';
$string['runtask_execute_five_courses'] = 'Process up to 5 items now';
$string['runtask_execute_one_course'] = 'Process 1 item now';
$string['runtask_execute_ten_courses'] = 'Process up to 10 items now';
$string['runtask_restore'] = 'Process restore queue';
...
$string['transfer_api'] = 'Transfer API';
...
$string['transfer_token_revoke'] = 'Revoke';
...
$string['transfer_token_status_expired'] = 'Expired';
$string['transfer_token_status_revoked'] = 'Revoked';
...
$string['transfer_restore_desc'] = 'Use this option to pull the backup list from the previous Moodle and place all remote MBZ files in the local restore queue. The token must be created on the previous Moodle.';
...
$string['transfer_restore_queue_button'] = 'Place remote restores in queue';
...
$string['transfer_restore_token_expired'] = 'Expired';
$string['transfer_restore_token_expired_before_restore'] = 'The transfer token expired before this backup could be restored.';
