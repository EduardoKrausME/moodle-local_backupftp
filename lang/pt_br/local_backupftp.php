...
$string['backup_destination_missing'] = 'O arquivo MBZ do backup não foi criado.';
$string['backup_end'] = 'Backup finalizado em';
$string['backup_end_time'] = 'Hora de término do backup';
$string['backup_errors_found_desc'] = '{$a} backup(s) apresentaram erro. Confira os detalhes e coloque os itens novamente na fila depois de corrigir o problema.';
$string['backup_errors_found_title'] = 'Existem erros de backup que precisam de atenção';
$string['backup_errors_open_report'] = 'Abrir relatório de backups';
$string['backup_ftp_upload_failed'] = 'Falha ao enviar o backup para {$a->remote_file}. Tamanho do arquivo: {$a->size}. Erro: {$a->error}';
$string['backup_no_destination'] = 'Nenhum destino de backup está habilitado. Ative o FTP ou o armazenamento local nas configurações do plugin.';
...
$string['backup_status_completed'] = 'Concluído';
$string['backup_status_error'] = 'Erro';
$string['backup_status_initiated'] = 'Em execução';
$string['backup_status_waiting'] = 'Aguardando';
$string['backup_tempfile_unreadable'] = 'O arquivo temporário do backup não pode ser lido: {$a}';
$string['backup_unexpected_error'] = 'Erro inesperado ao criar o backup: {$a}';
...
$string['manual_cron_result_error'] = 'A tarefa terminou com erros';
$string['manual_cron_result_success'] = 'A tarefa terminou com sucesso';
