...
$string['transfer_restore_token_remaining_log'] = 'Token prenosu je stále platný počas {$a}.';
...
$string['transfer_token_expired_before_restore'] = 'Token prenosu expiroval skôr, ako bolo možné túto zálohu obnoviť.';
