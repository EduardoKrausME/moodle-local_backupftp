...
$string['transfer_restore_token_remaining_log'] = 'Токен передачи все еще действителен в течение {$a}.';
...
$string['transfer_token_expired_before_restore'] = 'Токен передачи истек до того, как эта резервная копия могла быть восстановлена.';
