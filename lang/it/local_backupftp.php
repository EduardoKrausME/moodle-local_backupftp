...
$string['status'] = 'Stato';
$string['submit'] = 'Invia';
$string['temporary_files_deleted'] = 'File temporanei eliminati';
...
$string['transfer_restore_token_remaining_log'] = 'Token di trasferimento ancora valido per {$a}.';
...
$string['transfer_token_expired_before_restore'] = 'Il token di trasferimento è scaduto prima che questo backup potesse essere ripristinato.';
