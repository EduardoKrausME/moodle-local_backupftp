...
$string['transfer_restore_token_remaining_log'] = 'رمز النقل لا يزال صالحًا لمدة {$a}.';
...
$string['transfer_token_expired_before_restore'] = 'انتهت صلاحية رمز النقل قبل أن يمكن استعادة هذه النسخة الاحتياطية.';
