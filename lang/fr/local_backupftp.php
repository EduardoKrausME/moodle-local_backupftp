...
$string['transfer_restore_token_remaining_log'] = 'Jeton de transfert encore valide pendant {$a}.';
...
$string['transfer_token_expired_before_restore'] = 'Le jeton de transfert a expiré avant que cette sauvegarde puisse être restaurée.';
